...
- `Permissions` Add a read-only User, Object, and Profile page for OLS, FLS, user permissions, and custom permissions, with filter and CSV export [issue #1325](https://github.com/tprouvot/Salesforce-Inspector-reloaded/issues/1325)
